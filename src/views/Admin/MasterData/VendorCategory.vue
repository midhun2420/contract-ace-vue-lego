...
export default {
    ...
    data () {
        return {
            showAddForm  : false,
            listUrl      : urls.Admin.MasterData.VendorCategory.list,
            addUrl       : urls.Admin.MasterData.VendorCategory.addEdit,
            deleteUrl    : urls.Admin.MasterData.VendorCategory.delete,
            editingItem  : null,
            deletingItem : null,
            fields       : [
                {
