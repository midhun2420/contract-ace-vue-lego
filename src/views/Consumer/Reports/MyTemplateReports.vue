<template>
    <div class="card bs-5 m-4">
        <check-permission/>
        <vue-table-card :show-search-box="false" title="My Template Reports" :fields="fields" :url="listUrl" :per-page="10" ref="table">
<!--                        :extra-params="{ month }">-->
            <template #buttons>
                <div class="btn-group">
...
export default {
    ...
    data () {
        return {
            loading : false,
            listUrl : urls.Consumer.Reports.myTemplateList,
            fields  : [
                {
                    name      : 'id',
                    sortField : 'id',
    ...
    methods : {
        ReportDownload () {
            ...
            axios.get(urls.Consumer.Reports.myTemplateListDownload).then(function (data) {
